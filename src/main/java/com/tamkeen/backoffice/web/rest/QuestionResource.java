...
import com.tamkeen.backoffice.service.QuestionService;
...
/**
 * REST controller for managing {@link com.tamkeen.backoffice.domain.Question}.
 */
@RestController
...
public class QuestionResource {
    ...
    public ResponseEntity<QuestionDTO> createQuestion(@Valid @RequestBody QuestionDTO questionDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/questions/" + questionDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, questionDTO.getId()))
            .body(questionDTO);
    }
