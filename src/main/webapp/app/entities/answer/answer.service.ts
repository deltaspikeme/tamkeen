...
const baseSearchApiUrl = 'api/answers/_search?query=';
...
export default class AnswerService {
  ...
  public find(id: string): Promise<IAnswer> {
  ...
  public create(entity: IAnswer): Promise<IAnswer> {
    return new Promise<IAnswer>((resolve, reject) => {
      axios
  ...
  public update(entity: IAnswer): Promise<IAnswer> {
    return new Promise<IAnswer>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IAnswer): Promise<IAnswer> {
    return new Promise<IAnswer>((resolve, reject) => {
      axios
